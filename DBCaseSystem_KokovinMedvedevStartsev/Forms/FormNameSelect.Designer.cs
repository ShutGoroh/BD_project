namespace DBCaseSystem_KokovinMedvedevStartsev.Forms
{
    partial class FormNameSelect
    {
        ...
        private void InitializeComponent()
        {
			...
			this.label1.Text = "Введите имя для";
			// 
			// label2
			// 
			...
			this.Name = "FormNameSelect";
			this.Text = "FormNameSelect";
			this.Load += new System.EventHandler(this.FormNameSelect_Load);
